 ...
 !(function (e, t) {
    ...
    function y(e) {
        ...
        (e.__resize_handle = document.createElement("div")),
            S.extend(e.__resize_handle.style, { width: "6px", marginLeft: "-3px", height: "200px", cursor: "ew-resize", position: "absolute" }),
    ...
    var U = /(\d+(\.\d+)?)px/,
            ...
            fakeEvent: function (e, t, n, o) {
                ...
                switch (r) {
                    ...
                    case "KeyboardEvents":
                        ...
                        S.defaults(i, { cancelable: !0, ctrlKey: !1, altKey: !1, shiftKey: !1, metaKey: !1, keyCode: void 0, charCode: void 0 }),
        ...
        $ = (function (e) {
            function t(e, n) {
                ...
                return (
                    S.extend(h.__selector.style, { display: "none", width: "122px", height: "102px", padding: "3px", backgroundColor: "#222", boxShadow: "0px 1px 3px rgba(0,0,0,0.3)" }),
                    ...
                    S.extend(h.__hue_knob.style, { position: "absolute", width: "15px", height: "2px", borderRight: "4px solid #fff", zIndex: 1 }),
                    S.extend(h.__saturation_field.style, { width: "100px", height: "100px", border: "1px solid #555", marginRight: "3px", display: "inline-block", cursor: "pointer" }),
                    S.extend(f.style, { width: "100%", height: "100%", background: "none" }),
                    l(f, "top", "rgba(0,0,0,0)", "#000"),
                    S.extend(h.__hue_field.style, { width: "15px", height: "100px", border: "1px solid #555", cursor: "ns-resize", position: "absolute", top: "3px", right: "3px" }),
                    d(h.__hue_field),
        ...
        ie = (function () {
            function e() {
                F(this, e),
                    ...
                    S.extend(this.backgroundElement.style, { backgroundColor: "rgba(0,0,0,0.8)", top: 0, left: 0, display: "none", zIndex: "1000", opacity: 0, WebkitTransition: "opacity 0.2s linear", transition: "opacity 0.2s linear" }),
        ...
        he = function e(t) {
            ...
            if (
                ...
                (this.__closeButton = document.createElement("div")),
                    ...
                    o.closeOnTop
                        ? (X.addClass(this.__closeButton, e.CLASS_CLOSE_TOP), this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0]))
            ...
            o.autoPlace &&
                (S.isUndefined(o.parent) &&
                    (de && ((ce = document.createElement("div")), X.addClass(ce, "dg"), X.addClass(ce, e.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(ce), (de = !1)),
                ...
                if (e.scrollable) {
                    ...
                    S.each(e.__ul.childNodes, function (t) {
                        ...
                        window.innerHeight - t - 20 < n
                            ? (X.addClass(e.domElement, he.CLASS_TOO_TALL), (e.__ul.style.height = window.innerHeight - t - 20 + "px"))
